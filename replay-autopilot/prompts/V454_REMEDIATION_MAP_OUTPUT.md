...
Expected: Find "ExampleApplyTaskProcessor.*handleTaskResponse"
...
```json
{
  "wrong_test_surface": {
    ...
    "expected_output_pattern": "ExampleApplyTaskProcessor.*handleTaskResponse|ExamineFlowFacade.*autoClose",
  ...
  "core_entry_unclosed": {
    "fix_command": "Search-CoreEntryCarrier -TriggerSource ExampleApplyTaskProcessor -Exclude Parsers,Helpers",
    "expected_output_pattern": "ExampleFlowService.*executeAutoFlow|ExampleApplyTaskProcessor.*handleTaskResponse",
