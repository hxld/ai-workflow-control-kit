...
```powershell
powershell -NoProfile -ExecutionPolicy Bypass -File .\scripts\Invoke-PreExecutionConstraintCheck.ps1 -ReplayRoot REPLAY_ROOT -Worktree WORKTREE -PlanResultPath PLAN_RESULT.json
```
