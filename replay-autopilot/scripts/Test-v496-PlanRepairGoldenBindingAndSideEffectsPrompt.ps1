...
Assert-True 'repair_prompt_replaces_none_with_reason_binding' ($runLoopText.Contains('none_with_reason') -and $runLoopText.Contains('exact_contract_gap -> AiClaimDataAssemblyHelper.RequestBuildFunction'))
