...
def main():
    if len(sys.argv) < 2:
        ...
        print("  ensure_test_file_exists.py generate com.example.project.service.MyService processAutoFlow <PROJECT_ROOT>", file=sys.stderr)
        print("  ensure_test_file_exists.py verify <PROJECT_ROOT>\src\test\java\com\example\project\service\MyServiceTest.java", file=sys.stderr)
        sys.exit(1)
