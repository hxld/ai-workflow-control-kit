...
$result = & '.\scripts\Verify-PlanContract.ps1' -ReplayRoot 'D:\opt\replay-evidence\example-feature\claim-codex-replay-v438-autopilot-20260517-r02' 2>&1 | ConvertFrom-Json
Write-Host "Warnings:"
